...
;( function( window ) {
	...
	DragSlideshow.prototype._initDragDealer = function() {
		...
		$("#myNavBar a").on('click', function(e) {
	        e.preventDefault();
	   	    var gotoSlide = $(this).attr("data-x")
           
            //debugger;
           
            classie.remove( document.getElementById( 'slideshow' ), 'show-content' );
            slidesObject.enable();
            slidesObject.setStep(gotoSlide);
            //slidesObject.addEventListener( transEndEventName, onEndTransitionFn );
